...
namespace Assignment1
{
    class Program
    {
        ...
        {
            StringMultiplication sm = new StringMultiplication("120000", "34");
            Console.WriteLine(sm.Result);

            StringAdder sa = new StringAdder("3599", "99999", 10);
            Console.WriteLine(sa.Result);

            StringDivider sd = new StringDivider("123", 2);
            Debug.Assert(sd.Q == "61");
            Debug.Assert(sd.R == "1");

            sd = new StringDivider("123", 16);
            Debug.Assert(sd.Q == "7");
            Debug.Assert(sd.R == "11");

            sd = new StringDivider("1234", 2);
            Debug.Assert(sd.Q == "617");
            Debug.Assert(sd.R == "0");

            sd = new StringDivider("1234", 16);
            Debug.Assert(sd.Q == "77");
            Debug.Assert(sd.R == "2");

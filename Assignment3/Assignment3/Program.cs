...
namespace Assignment3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //INoise noise = new CosineNoise();
            //int[] steps = new int[] { 10, -1 };
            //List<int> expectedSteps = new List<int> { 10, 12, 8, 3, -2, -1 };

            //List<int> newSteps = StepMaker.MakeSteps(steps, noise);

            //Debug.Assert(newSteps.Count == expectedSteps.Count);

            //for (int i = 0; i < expectedSteps.Count; i++)
            //{
            //    Debug.Assert(expectedSteps[i] == newSteps[i]);
            //}
